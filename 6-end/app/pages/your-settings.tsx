...
type State = { newName: string; publicAddress: string; newAvatarUrl: string; disabled: boolean };
...
class YourSettings extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const { newName, publicAddress, newAvatarUrl } = this.state;
